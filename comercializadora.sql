...
CREATE TABLE `cliente` (
  ...
  `apelldoM` varchar(45) DEFAULT NULL,
...
CREATE TABLE `pedido` (
  ...
  KEY `codigo_cliente_idx` (`codigo_cliente`),
  CONSTRAINT `codigo_cliente` FOREIGN KEY (`codigo_cliente`) REFERENCES `cliente` (`codigo_cliente`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-06-26 15:54:03
